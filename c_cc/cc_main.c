...
int main(int argc, char** argv) {
	...
	str_result(results_buffer[9], "test_piece_combo()", test_piece_combo());
	...
	str_result(results_buffer[14], "test_iterate_piece_combos()", test_iterate_piece_combos());
	str_result(results_buffer[15], "test_best_match()", test_best_match());
	str_result(results_buffer[16], "test_remove_combos()", test_remove_combos());
	str_result(results_buffer[17], "test_sort()", test_sort());
